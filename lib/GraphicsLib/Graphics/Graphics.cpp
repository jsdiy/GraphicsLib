...
void	Graphics::DrawLine(int16_t x1, int16_t y1, int16_t x2, int16_t y2, const Color& color)
{
...
//水平線を描画する
void	Graphics::DrawLineH(int16_t x1, int16_t y1, int16_t x2, const Color& color)
{
...
//垂直線を描画する
void	Graphics::DrawLineV(int16_t x1, int16_t y1, int16_t y2, const Color& color)
{
...
void	Graphics::SwapPoint(int16_t* x1, int16_t* y1, int16_t* x2, int16_t* y2)
{
	std::swap(x1, x2);
	std::swap(y1, y2);
}
...
//矩形を描く
void	Graphics::DrawRect(int16_t x, int16_t y, int16_t w, int16_t h, const Color& color)
{
...
void	Graphics::DrawTriangle(int16_t x1, int16_t y1, int16_t x2, int16_t y2, int16_t x3, int16_t y3, const Color& color)
{
...
//塗りつぶした三角形を描く
//引数:	頂点の座標(x1,y1)、(x2,y2)、(x3,y3)
void	Graphics::FillTriangle(int16_t x1, int16_t y1, int16_t x2, int16_t y2, int16_t x3, int16_t y3, const Color& color)
{
	//x座標の小さい順にソートする
...
*/
void	Graphics::FillBetweenLine(int16_t x1s, int16_t y1s, int16_t x1e, int16_t y1e,
...
//円を描く
//引数:	中心座標、半径、塗りつぶしフラグ
void	Graphics::DrawCircleWithFillFlag(int16_t cx, int16_t cy, int16_t r, uint8_t isFill, const Color& color)
{
	/*
	弧を描くアルゴリズム：
